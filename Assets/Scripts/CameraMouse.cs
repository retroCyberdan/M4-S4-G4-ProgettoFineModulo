...
public class CameraMouse : MonoBehaviour
{
    ...
    public float distance = 5.0f;      // <- distanza dal target
    public float xSpeed = 120.0f;      // <- velocità di rotazione orizzontale
    public float ySpeed = 80.0f;       // <- velocità di rotazione verticale
